...
// Special Battle League Trainers
#define LEAGUE_TRAINER_CLASS_ROOKIE    TRAINER_CLASS_YOUNGSTER
#define LEAGUE_TRAINER_CLASS_GREAT     TRAINER_CLASS_COOLTRAINER_M  
#define LEAGUE_TRAINER_CLASS_ULTRA     TRAINER_CLASS_ACE_TRAINER_M
#define LEAGUE_TRAINER_CLASS_MASTER    TRAINER_CLASS_EXPERT_M
#define LEAGUE_TRAINER_CLASS_CHAMPION  TRAINER_CLASS_CHAMPION
